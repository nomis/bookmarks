...
Rails.application.routes.draw do
  ...
  get "/bookmarks/incremental", to: "bookmarks#incremental", as: :incremental_bookmark, constraints: { format: ["json"] }
  ...
  get "/lookup/url", to: "lookup#url", as: :lookup_url, constraints: { format: ["json"] }
